...
#define NUM_PODS                4
#define NUM_HOSTS               (NUM_PODS * NUM_PODS * NUM_PODS) / 4
#define NUM_AGGREGATE_SWITCHES  (NUM_PODS * (NUM_PODS / 2))
#define NUM_EDGE_SWITCHES       (NUM_PODS * (NUM_PODS / 2))
#define NUM_CORE_SWITCHES       (NUM_PODS * NUM_PODS) / 4
#define NUM_PORTS_UP            NUM_PODS / 2
#define NUM_PORTS_DOWN          NUM_PODS / 2

#define UPSTREAM_BUFFER_LEN (3 * NUM_PODS)
#define DOWNSTREAM_BUFFER_LEN (5 * NUM_PODS)
#define CORE_PORT_BUFFER_LEN (4 * NUM_PODS)
